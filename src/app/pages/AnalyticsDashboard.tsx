      ...
      <div className="flex-1 pb-20 pt-14 md:pt-0 md:pb-0 min-w-0">
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-5">
          ...
          <div className="bg-card rounded-xl border border-border p-5">
            <h2 className="text-sm font-semibold text-foreground mb-4">Weekly Scan Activity</h2>
            <div className="h-56">
          ...
          <div className="bg-card rounded-xl border border-border p-5">
            <h2 className="text-sm font-semibold text-foreground mb-4">Tickets by College</h2>
            <div className="h-56">
              <ResponsiveContainer width="100%" height="100%">
